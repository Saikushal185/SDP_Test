...
export function ExplainabilityChatbot({
  ...
  const hasExactPrediction = Boolean(prediction?.explanation);
  ...
  return (
    <div className="xai-chatbot">
      ...
      <form className="chat-input-row" onSubmit={handleSubmit}>
        <input
          value={draft}
          placeholder={hasExactPrediction ? "Ask about this prediction" : "Ask a general XAI question"}
